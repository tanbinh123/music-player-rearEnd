...
public class SongController {
    ...
    public Object addSong(HttpServletRequest request, @RequestParam("file") MultipartFile mpFile) { // 添加歌曲
    ...
    public Object songOfSingerId(HttpServletRequest request) { // 根据歌手id查询歌曲
        String singerId = request.getParameter("singerId");
        return songService.songOfSingerId(Integer.parseInt(singerId));
    }

    @RequestMapping(value = "/update", method = RequestMethod.POST)
    public Object updateSong(HttpServletRequest request) { // 修改歌曲
        JSONObject jsonObject = new JSONObject();
    ...
    public Object deleteSinger(HttpServletRequest request) { // 删除歌曲
    ...
    public Object updateSongPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id") int id) { // 更新歌曲图片
        JSONObject jsonObject = new JSONObject();
    ...
    public Object updateSongUrl(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id") int id) { // 更新歌曲
        JSONObject jsonObject = new JSONObject();
        if (avatorFile.isEmpty()) {
            jsonObject.put(Consts.CODE, 0);
            jsonObject.put(Consts.MSG, "文件上传失败");
