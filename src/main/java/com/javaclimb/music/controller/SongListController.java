...
public class SongListController {
    ...
    public Object addSongList(HttpServletRequest request) { // 添加歌单
    ...
    public Object updateSongList(HttpServletRequest request) { // 修改歌单
        JSONObject jsonObject = new JSONObject();
    ...
    public Object deleteSongList(HttpServletRequest request) { // 删除歌单
        String id = request.getParameter("id").trim(); // 主键
    ...
    public Object selectByPrimaryKey(HttpServletRequest request) { // 根据主键查询整个对象
        String id = request.getParameter("id").trim(); // 主键
        return songListService.selectByPrimaryKey(Integer.parseInt(id));
    }

    @RequestMapping(value = "/allSongList", method = RequestMethod.GET)
    public Object allSongList(HttpServletRequest request) { // 查询所有歌单
        return songListService.allSongList();
    }

    @RequestMapping(value = "/songListOfTitle", method = RequestMethod.GET)
    public Object songListOfName(HttpServletRequest request) { // 根据标题名字模糊查询列表
    ...
    public Object likeTitle(HttpServletRequest request) { // 根据标题模糊查询歌单列表
        String title = request.getParameter("title").trim(); // 歌单标题
        return songListService.likeTitle("%" + title + "%");
    }

    @RequestMapping(value = "/likeStyle", method = RequestMethod.GET)
    public Object likeStyle(HttpServletRequest request) { // 根据风格模糊查询歌单列表
    ...
    public Object updateSongListPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id") int id) { // 更新歌手图片
        JSONObject jsonObject = new JSONObject();
